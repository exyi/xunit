...
/// <summary>
/// Context record for <see cref="XunitTestInvoker"/>
/// </summary>
public record XunitTestInvokerContext : TestInvokerContext
{
	/// <summary>
	/// Initializes a new instance of the <see cref="XunitTestInvokerContext"/> record.
	/// </summary>
