...
public class XunitDelayEnumeratedTheoryTestCaseRunnerTests
{
	...
	class TestableXunitDelayEnumeratedTheoryTestCaseRunner : XunitDelayEnumeratedTheoryTestCaseRunner
	{
		...
		public ValueTask<RunSummary> RunAsync() =>
			RunAsync(testCase, messageBus, new ExceptionAggregator(), new CancellationTokenSource(), displayName, null, Array.Empty<object>(), Array.Empty<object>(), SpyMessageSink.Create());
	}
}
